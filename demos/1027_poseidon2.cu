...
__global__ void poseidon2_add_rc_kernel(forge_span_u32_t state __attribute__((unused)), forge_span_u32_t rc __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  if ((gid < n)) {
    ...
    state.data[(base + 0ULL)] = m31_add(e0, r0);
    state.data[(base + 1ULL)] = m31_add(e1, r1);
    state.data[(base + 2ULL)] = m31_add(e2, r2);
    state.data[(base + 3ULL)] = m31_add(e3, r3);
    state.data[(base + 4ULL)] = m31_add(e4, r4);
    state.data[(base + 5ULL)] = m31_add(e5, r5);
    state.data[(base + 6ULL)] = m31_add(e6, r6);
    state.data[(base + 7ULL)] = m31_add(e7, r7);
    state.data[(base + 8ULL)] = m31_add(e8, r8);
    state.data[(base + 9ULL)] = m31_add(e9, r9);
    state.data[(base + 10ULL)] = m31_add(e10, r10);
    state.data[(base + 11ULL)] = m31_add(e11, r11);
    state.data[(base + 12ULL)] = m31_add(e12, r12);
    state.data[(base + 13ULL)] = m31_add(e13, r13);
    state.data[(base + 14ULL)] = m31_add(e14, r14);
    state.data[(base + 15ULL)] = m31_add(e15, r15);
