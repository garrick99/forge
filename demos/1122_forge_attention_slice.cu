...
int main();
__global__ void attention_slice(forge_span_f32_t Q __attribute__((unused)), forge_span_f32_t K __attribute__((unused)), forge_span_f32_t V __attribute__((unused)), forge_span_f32_t O __attribute__((unused)), uint64_t seq_len __attribute__((unused)), uint64_t d __attribute__((unused)));
int main();
...
__global__ void attention_slice(forge_span_f32_t Q __attribute__((unused)), forge_span_f32_t K __attribute__((unused)), forge_span_f32_t V __attribute__((unused)), forge_span_f32_t O __attribute__((unused)), uint64_t seq_len __attribute__((unused)), uint64_t d __attribute__((unused))) {
  ...
  if ((gid < seq_len)) {
    ...
    float max_s __attribute__((unused)) = (-1e+30);
    uint64_t j __attribute__((unused)) = 0ULL;
    {
      while ((j < seq_len)) {
        ...
        {
          while ((e < d)) {
            s = (s + (Q.data[((gid * d) + e)] * K.data[((j * d) + e)]));
            e = (e + 1ULL);
          }

        }
        float sc __attribute__((unused)) = (s * scale);
        if ((sc > max_s)) {
          max_s = sc;
    ...
    float denom __attribute__((unused)) = 0;
    uint64_t j2 __attribute__((unused)) = 0ULL;
    {
      while ((j2 < seq_len)) {
        ...
        {
          while ((e < d)) {
            s = (s + (Q.data[((gid * d) + e)] * K.data[((j2 * d) + e)]));
            e = (e + 1ULL);
          }
    ...
    {
      while ((k < d)) {
        float acc __attribute__((unused)) = 0;
        uint64_t j3 __attribute__((unused)) = 0ULL;
        {
          while ((j3 < seq_len)) {
            float s __attribute__((unused)) = 0;
            uint64_t e __attribute__((unused)) = 0ULL;
            {
              while ((e < d)) {
                s = (s + (Q.data[((gid * d) + e)] * K.data[((j3 * d) + e)]));
                e = (e + 1ULL);
              }

            }
            float w __attribute__((unused)) = (expf(((s * scale) - max_s)) / denom);
            acc = (acc + (w * V.data[((j3 * d) + k)]));
            j3 = (j3 + 1ULL);
          }
...
/* ---- FORGE ASSUMPTION AUDIT LOG ----
   Total assumptions: 1
   [ASSUME] demos/1122_forge_attention_slice.fg:85  (> denom 0)
