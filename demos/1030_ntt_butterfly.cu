...
__global__ void ntt_butterfly_kernel(forge_span_u32_t data __attribute__((unused)), forge_span_u32_t twiddle __attribute__((unused)), uint64_t half_n __attribute__((unused)));
__global__ void intt_butterfly_kernel(forge_span_u32_t data __attribute__((unused)), forge_span_u32_t twiddle __attribute__((unused)), uint64_t half_n __attribute__((unused)));
__global__ void ntt_scale_kernel(forge_span_u32_t data __attribute__((unused)), uint32_t inv_n __attribute__((unused)), uint64_t n __attribute__((unused)));
__global__ void ntt_bitrev_kernel(forge_span_u32_t data __attribute__((unused)), forge_span_u64_t rev __attribute__((unused)), uint64_t n __attribute__((unused)));
int main();
...
__global__ void intt_butterfly_kernel(forge_span_u32_t data __attribute__((unused)), forge_span_u32_t twiddle __attribute__((unused)), uint64_t half_n __attribute__((unused))) {
  ...
  if ((tid < half_n)) {
    ...
    uint32_t b __attribute__((unused)) = m31_get(data, (tid + half_n));
    uint32_t w __attribute__((unused)) = m31_get(twiddle, tid);
    uint32_t a2 __attribute__((unused)) = m31_add(a, b);
    uint32_t d __attribute__((unused)) = m31_sub(a, b);
    uint32_t b2 __attribute__((unused)) = m31_mul(w, d);
    data.data[tid] = a2;
    data.data[(tid + half_n)] = b2;
...
__global__ void ntt_bitrev_kernel(forge_span_u32_t data __attribute__((unused)), forge_span_u64_t rev __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  if ((tid < n)) {
    /* assert erased */;
    /* assert erased */;
    uint64_t rtid __attribute__((unused)) = rev.data[tid];
    /* assert erased */;
    if ((rtid > tid)) {
      uint32_t va __attribute__((unused)) = m31_get(data, tid);
      uint32_t vb __attribute__((unused)) = m31_get(data, rtid);
      data.data[tid] = vb;
      data.data[rtid] = va;
