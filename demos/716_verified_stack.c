...
void stack_push_n(Vec_u64* s __attribute__((unused)), forge_span_u64_t src __attribute__((unused)), uint64_t n __attribute__((unused)));
void stack_drain(Vec_u64* s __attribute__((unused)), forge_span_u64_t dst __attribute__((unused)), uint64_t n __attribute__((unused)));
void stack_fill_all(Vec_u64* s __attribute__((unused)), uint64_t val __attribute__((unused)));
void stack_push_pop_len(Vec_u64* s __attribute__((unused)), uint64_t val __attribute__((unused)));
int main();
...
void stack_push_pop_len(Vec_u64* s __attribute__((unused)), uint64_t val __attribute__((unused))) {
  uint64_t old_len __attribute__((unused)) = (*s).len;
  vec_u64_push(s, val);
  (void)(vec_u64_pop(s));
}
