...
__global__ void prefix_product_upsweep_kernel(forge_span_u32_t prefix __attribute__((unused)), uint64_t stride __attribute__((unused)), uint64_t n __attribute__((unused)));
__global__ void prefix_product_downsweep_kernel(forge_span_u32_t prefix __attribute__((unused)), uint64_t stride __attribute__((unused)), uint64_t n __attribute__((unused)));
__global__ void batch_inverse_suffix_kernel(forge_span_u32_t inv __attribute__((unused)), forge_span_u32_t prefix __attribute__((unused)), forge_span_u32_t a __attribute__((unused)), uint32_t inv_total __attribute__((unused)), uint64_t n __attribute__((unused)));
__global__ void fermat_inverse_kernel(forge_span_u32_t inv __attribute__((unused)), forge_span_u32_t a __attribute__((unused)), uint64_t n __attribute__((unused)));
int main();
...
__global__ void prefix_product_upsweep_kernel(forge_span_u32_t prefix __attribute__((unused)), uint64_t stride __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  uint64_t pos __attribute__((unused)) = ((((tid + 1ULL) * stride) * 2ULL) - 1ULL);
  if ((pos < n)) {
    /* assert erased */;
    uint64_t src __attribute__((unused)) = (pos - stride);
    /* assert erased */;
    uint32_t a __attribute__((unused)) = m31_get(prefix, src);
    uint32_t b __attribute__((unused)) = m31_get(prefix, pos);
    prefix.data[pos] = m31_mul(a, b);
...
__global__ void prefix_product_downsweep_kernel(forge_span_u32_t prefix __attribute__((unused)), uint64_t stride __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  if (((pos + stride) < n)) {
    /* assert erased */;
    uint64_t dst __attribute__((unused)) = (pos + stride);
    /* assert erased */;
    uint32_t a __attribute__((unused)) = m31_get(prefix, pos);
    uint32_t b __attribute__((unused)) = m31_get(prefix, dst);
    prefix.data[dst] = m31_mul(a, b);
...
__global__ void batch_inverse_suffix_kernel(forge_span_u32_t inv __attribute__((unused)), forge_span_u32_t prefix __attribute__((unused)), forge_span_u32_t a __attribute__((unused)), uint32_t inv_total __attribute__((unused)), uint64_t n __attribute__((unused))) {
  uint64_t tid __attribute__((unused)) = ((blockIdx_x * blockDim_x) + threadIdx_x);
  if ((tid == 0ULL)) {
    uint32_t acc __attribute__((unused)) = inv_total;
    if ((n > 1ULL)) {
      uint64_t nm2 __attribute__((unused)) = (n - 2ULL);
      /* assert erased */;
      uint64_t nm1 __attribute__((unused)) = (n - 1ULL);
      /* assert erased */;
      /* assert erased */;
      uint32_t pnm2 __attribute__((unused)) = m31_get(prefix, nm2);
      uint32_t anm1 __attribute__((unused)) = m31_get(a, nm1);
      inv.data[nm1] = m31_mul(acc, pnm2);
      acc = m31_mul(acc, anm1);
      if ((n > 2ULL)) {
        uint64_t nm2i __attribute__((unused)) = (n - 2ULL);
        /* assert erased */;
        /* assert erased */;
        uint64_t nm3 __attribute__((unused)) = (n - 3ULL);
        /* assert erased */;
        uint32_t pnm3 __attribute__((unused)) = m31_get(prefix, nm3);
        uint32_t anm2 __attribute__((unused)) = m31_get(a, nm2i);
        inv.data[nm2i] = m31_mul(acc, pnm3);
        acc = m31_mul(acc, anm2);
        if ((n > 3ULL)) {
          uint64_t nm3i __attribute__((unused)) = (n - 3ULL);
          /* assert erased */;
          /* assert erased */;
          uint64_t nm4 __attribute__((unused)) = (n - 4ULL);
          /* assert erased */;
          uint32_t pnm4 __attribute__((unused)) = m31_get(prefix, nm4);
          uint32_t anm3 __attribute__((unused)) = m31_get(a, nm3i);
          inv.data[nm3i] = m31_mul(acc, pnm4);
...
__global__ void fermat_inverse_kernel(forge_span_u32_t inv __attribute__((unused)), forge_span_u32_t a __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  if ((tid < n)) {
    /* assert erased */;
    /* assert erased */;
    uint32_t x __attribute__((unused)) = m31_get(a, tid);
    uint32_t x2 __attribute__((unused)) = m31_mul(x, x);
    uint32_t x3 __attribute__((unused)) = m31_mul(x2, x);
    uint32_t x6 __attribute__((unused)) = m31_mul(x3, x3);
    uint32_t x12 __attribute__((unused)) = m31_mul(x6, x6);
    uint32_t x24 __attribute__((unused)) = m31_mul(x12, x12);
    uint32_t x30 __attribute__((unused)) = m31_mul(x24, x6);
    uint32_t almost __attribute__((unused)) = m31_mul(x30, x2);
    inv.data[tid] = m31_mul(almost, x3);
