...
__global__ void vec_memory_mix3(uint32_t* __restrict__ a, uint64_t a_len, uint32_t* __restrict__ b, uint64_t b_len, uint32_t* __restrict__ c, uint64_t c_len, uint32_t n) {
