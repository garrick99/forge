...
void map_add(forge_span_u64_t dst __attribute__((unused)), forge_span_u64_t src __attribute__((unused)), uint64_t n __attribute__((unused)), uint64_t offset __attribute__((unused)));
int main();
