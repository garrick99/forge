...
__global__ void fri_fold_layer(forge_span_u32_t new_evals __attribute__((unused)), forge_span_u32_t old_evals __attribute__((unused)), uint32_t alpha __attribute__((unused)), uint64_t half __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  if ((i < half)) {
    uint32_t a __attribute__((unused)) = m31_get(old_evals, i);
    uint32_t b __attribute__((unused)) = m31_get(old_evals, (i + half));
    uint32_t ab __attribute__((unused)) = m31_mul(alpha, b);
    new_evals.data[i] = m31_add(a, ab);
...
__global__ void fri_fold_layer_cm31(forge_span_u32_t new_re __attribute__((unused)), forge_span_u32_t new_im __attribute__((unused)), forge_span_u32_t old_re __attribute__((unused)), forge_span_u32_t old_im __attribute__((unused)), uint32_t alpha_re __attribute__((unused)), uint32_t alpha_im __attribute__((unused)), uint64_t half __attribute__((unused)), uint64_t n __attribute__((unused))) {
  uint64_t i __attribute__((unused)) = ((blockIdx_x * blockDim_x) + threadIdx_x);
  if ((i < half)) {
    uint32_t a_re __attribute__((unused)) = m31_get(old_re, i);
    uint32_t a_im __attribute__((unused)) = m31_get(old_im, i);
    uint32_t b_re __attribute__((unused)) = m31_get(old_re, (i + half));
    uint32_t b_im __attribute__((unused)) = m31_get(old_im, (i + half));
    uint32_t ab_re __attribute__((unused)) = cm31_mul_re(alpha_re, alpha_im, b_re, b_im);
    uint32_t ab_im __attribute__((unused)) = cm31_mul_im(alpha_re, alpha_im, b_re, b_im);
    new_re.data[i] = m31_add(a_re, ab_re);
    new_im.data[i] = m31_add(a_im, ab_im);
