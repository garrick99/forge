...
__global__ void linepoly_fold_m31_kernel(forge_span_u32_t out __attribute__((unused)), forge_span_u32_t eval __attribute__((unused)), forge_span_u32_t inv_2y __attribute__((unused)), uint32_t alpha __attribute__((unused)), uint32_t inv2 __attribute__((unused)), uint64_t half __attribute__((unused)));
__global__ void linepoly_fold_qm31_kernel(forge_span_u32_t out_rr __attribute__((unused)), forge_span_u32_t out_ri __attribute__((unused)), forge_span_u32_t out_ir __attribute__((unused)), forge_span_u32_t out_ii __attribute__((unused)), forge_span_u32_t eval __attribute__((unused)), forge_span_u32_t inv_2y __attribute__((unused)), uint32_t alpha_rr __attribute__((unused)), uint32_t alpha_ri __attribute__((unused)), uint32_t alpha_ir __attribute__((unused)), uint32_t alpha_ii __attribute__((unused)), uint32_t inv2 __attribute__((unused)), uint64_t half __attribute__((unused)));
__global__ void linepoly_eval_kernel(forge_span_u32_t out __attribute__((unused)), forge_span_u32_t x_coord __attribute__((unused)), uint32_t f0 __attribute__((unused)), uint32_t f1 __attribute__((unused)), uint64_t n __attribute__((unused)));
int main();
...
__global__ void linepoly_fold_m31_kernel(forge_span_u32_t out __attribute__((unused)), forge_span_u32_t eval __attribute__((unused)), forge_span_u32_t inv_2y __attribute__((unused)), uint32_t alpha __attribute__((unused)), uint32_t inv2 __attribute__((unused)), uint64_t half __attribute__((unused))) {
  ...
  if ((tid < half)) {
    ...
    /* assert erased */;
    /* assert erased */;
    uint32_t fp __attribute__((unused)) = m31_get(eval, tid);
    uint32_t fm __attribute__((unused)) = m31_get(eval, (tid + half));
    uint32_t iy __attribute__((unused)) = m31_get(inv_2y, tid);
    uint32_t sum __attribute__((unused)) = m31_add(fp, fm);
    uint32_t f_even_half __attribute__((unused)) = m31_mul(sum, inv2);
    uint32_t diff __attribute__((unused)) = m31_sub(fp, fm);
    uint32_t f_odd __attribute__((unused)) = m31_mul(diff, iy);
    uint32_t contrib __attribute__((unused)) = m31_mul(alpha, f_odd);
    out.data[tid] = m31_add(f_even_half, contrib);
...
__global__ void linepoly_fold_qm31_kernel(forge_span_u32_t out_rr __attribute__((unused)), forge_span_u32_t out_ri __attribute__((unused)), forge_span_u32_t out_ir __attribute__((unused)), forge_span_u32_t out_ii __attribute__((unused)), forge_span_u32_t eval __attribute__((unused)), forge_span_u32_t inv_2y __attribute__((unused)), uint32_t alpha_rr __attribute__((unused)), uint32_t alpha_ri __attribute__((unused)), uint32_t alpha_ir __attribute__((unused)), uint32_t alpha_ii __attribute__((unused)), uint32_t inv2 __attribute__((unused)), uint64_t half __attribute__((unused))) {
  ...
  if ((tid < half)) {
    ...
    uint32_t diff __attribute__((unused)) = m31_sub(fp, fm);
    uint32_t f_odd __attribute__((unused)) = m31_mul(diff, iy);
    uint32_t c_rr __attribute__((unused)) = m31_mul(alpha_rr, f_odd);
    uint32_t c_ri __attribute__((unused)) = m31_mul(alpha_ri, f_odd);
    uint32_t c_ir __attribute__((unused)) = m31_mul(alpha_ir, f_odd);
    uint32_t c_ii __attribute__((unused)) = m31_mul(alpha_ii, f_odd);
    out_rr.data[tid] = m31_add(f_even_half, c_rr);
    out_ri.data[tid] = c_ri;
    out_ir.data[tid] = c_ir;
    out_ii.data[tid] = c_ii;
...
__global__ void linepoly_eval_kernel(forge_span_u32_t out __attribute__((unused)), forge_span_u32_t x_coord __attribute__((unused)), uint32_t f0 __attribute__((unused)), uint32_t f1 __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  if ((tid < n)) {
    /* assert erased */;
    /* assert erased */;
    uint32_t t __attribute__((unused)) = m31_get(x_coord, tid);
    uint32_t f1t __attribute__((unused)) = m31_mul(f1, t);
    out.data[tid] = m31_add(f0, f1t);
