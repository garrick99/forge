...
void add_spans(forge_span_u64_t out __attribute__((unused)), forge_span_u64_t a __attribute__((unused)), forge_span_u64_t b __attribute__((unused)), uint64_t n __attribute__((unused)));
int main();
