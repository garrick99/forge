...
uint64_t roundtrip(forge_span_u64_t data __attribute__((unused)), uint64_t n __attribute__((unused)), forge_span_u64_t comp_buf __attribute__((unused)), uint64_t comp_cap __attribute__((unused)), forge_span_u64_t decomp_buf __attribute__((unused)), uint64_t decomp_cap __attribute__((unused)));
int main();
...
uint64_t roundtrip(forge_span_u64_t data __attribute__((unused)), uint64_t n __attribute__((unused)), forge_span_u64_t comp_buf __attribute__((unused)), uint64_t comp_cap __attribute__((unused)), forge_span_u64_t decomp_buf __attribute__((unused)), uint64_t decomp_cap __attribute__((unused))) {
  uint64_t raw_len __attribute__((unused)) = lz_compress(data, n, comp_buf, comp_cap);
  uint64_t comp_len;
  if ((raw_len <= comp_cap)) {
    comp_len = raw_len;
  } else {
  ...
  return lz_decompress(comp_buf, comp_len, decomp_buf, decomp_cap);
}
