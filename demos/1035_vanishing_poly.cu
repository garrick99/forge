...
__global__ void quotient_by_inv_vanishing_kernel(forge_span_u32_t quot __attribute__((unused)), forge_span_u32_t constraint __attribute__((unused)), forge_span_u32_t inv_z __attribute__((unused)), uint64_t n __attribute__((unused)));
__global__ void boundary_quotient_kernel(forge_span_u32_t bquot __attribute__((unused)), forge_span_u32_t trace __attribute__((unused)), forge_span_u32_t inv_z_boundary __attribute__((unused)), uint32_t boundary_val __attribute__((unused)), uint64_t n __attribute__((unused)));
__global__ void combine_quotients_kernel(forge_span_u32_t combined __attribute__((unused)), forge_span_u32_t constraint_quot __attribute__((unused)), forge_span_u32_t boundary_quot __attribute__((unused)), uint32_t alpha __attribute__((unused)), uint32_t beta __attribute__((unused)), uint64_t n __attribute__((unused)));
__global__ void coset_blowup_shift_kernel(forge_span_u32_t blowup __attribute__((unused)), forge_span_u32_t quot __attribute__((unused)), forge_span_u32_t shift_power __attribute__((unused)), uint64_t n __attribute__((unused)));
int main();
...
__global__ void quotient_by_inv_vanishing_kernel(forge_span_u32_t quot __attribute__((unused)), forge_span_u32_t constraint __attribute__((unused)), forge_span_u32_t inv_z __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  if ((x < n)) {
    ...
    /* assert erased */;
    /* assert erased */;
    uint32_t c __attribute__((unused)) = m31_get(constraint, x);
    uint32_t z __attribute__((unused)) = m31_get(inv_z, x);
    quot.data[x] = m31_mul(c, z);
...
__global__ void boundary_quotient_kernel(forge_span_u32_t bquot __attribute__((unused)), forge_span_u32_t trace __attribute__((unused)), forge_span_u32_t inv_z_boundary __attribute__((unused)), uint32_t boundary_val __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  if ((x < n)) {
    ...
    /* assert erased */;
    /* assert erased */;
    uint32_t t __attribute__((unused)) = m31_get(trace, x);
    uint32_t z __attribute__((unused)) = m31_get(inv_z_boundary, x);
    uint32_t num __attribute__((unused)) = m31_sub(t, boundary_val);
    bquot.data[x] = m31_mul(num, z);
...
__global__ void combine_quotients_kernel(forge_span_u32_t combined __attribute__((unused)), forge_span_u32_t constraint_quot __attribute__((unused)), forge_span_u32_t boundary_quot __attribute__((unused)), uint32_t alpha __attribute__((unused)), uint32_t beta __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  if ((x < n)) {
    ...
    /* assert erased */;
    /* assert erased */;
    uint32_t cq __attribute__((unused)) = m31_get(constraint_quot, x);
    uint32_t bq __attribute__((unused)) = m31_get(boundary_quot, x);
    uint32_t t1 __attribute__((unused)) = m31_mul(alpha, cq);
    uint32_t t2 __attribute__((unused)) = m31_mul(beta, bq);
    combined.data[x] = m31_add(t1, t2);
...
__global__ void coset_blowup_shift_kernel(forge_span_u32_t blowup __attribute__((unused)), forge_span_u32_t quot __attribute__((unused)), forge_span_u32_t shift_power __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  if ((x < n)) {
    ...
    uint32_t s __attribute__((unused)) = m31_get(shift_power, x);
    blowup.data[x] = m31_mul(q, s);
