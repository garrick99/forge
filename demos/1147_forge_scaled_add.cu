...
__global__ void scaled_add(forge_span_f32_t x __attribute__((unused)), forge_span_f32_t y __attribute__((unused)), forge_span_f32_t out __attribute__((unused)), uint64_t n __attribute__((unused)), float alpha __attribute__((unused)), float beta __attribute__((unused)));
int main();

__global__ void scaled_add(forge_span_f32_t x __attribute__((unused)), forge_span_f32_t y __attribute__((unused)), forge_span_f32_t out __attribute__((unused)), uint64_t n __attribute__((unused)), float alpha __attribute__((unused)), float beta __attribute__((unused))) {
  uint64_t gid __attribute__((unused)) = ((blockIdx_x * ((uint64_t)blockDim_x)) + ((uint64_t)threadIdx_x));
  if ((gid < n)) {
    out.data[gid] = ((alpha * x.data[gid]) + (beta * y.data[gid]));
