...
__global__ void layernorm_affine(forge_span_f32_t inp __attribute__((unused)), forge_span_f32_t out __attribute__((unused)), forge_span_f32_t gamma __attribute__((unused)), forge_span_f32_t beta __attribute__((unused)), uint64_t n_cols __attribute__((unused)));
int main();
...
__global__ void layernorm_affine(forge_span_f32_t inp __attribute__((unused)), forge_span_f32_t out __attribute__((unused)), forge_span_f32_t gamma __attribute__((unused)), forge_span_f32_t beta __attribute__((unused)), uint64_t n_cols __attribute__((unused))) {
  ...
  float mean __attribute__((unused)) = (smem[0ULL] / n_f);
  ...
  float var_ __attribute__((unused)) = (smem[0ULL] / n_f);
  float inv_std __attribute__((unused)) = rsqrtf((var_ + eps));
  if ((tid < n_cols)) {
    float g __attribute__((unused)) = gamma.data[tid];
    float b __attribute__((unused)) = beta.data[tid];
    out.data[(base + tid)] = (((d * inv_std) * g) + b);
