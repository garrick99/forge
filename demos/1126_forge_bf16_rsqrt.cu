...
__global__ void bf16_rsqrt(forge_span_u16_t inp __attribute__((unused)), forge_span_u16_t out __attribute__((unused)), uint64_t n __attribute__((unused)));
int main();
...
__global__ void bf16_rsqrt(forge_span_u16_t inp __attribute__((unused)), forge_span_u16_t out __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  if ((gid < n)) {
    float x_f __attribute__((unused)) = __bfloat162float(inp.data[gid]);
    float y_f __attribute__((unused)) = rsqrtf(x_f);
    out.data[gid] = __float2bfloat16(y_f);
