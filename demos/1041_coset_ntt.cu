...
__global__ void coset_ntt_preprocess_kernel(forge_span_u32_t data __attribute__((unused)), forge_span_u32_t shift_powers __attribute__((unused)), uint64_t n __attribute__((unused)));
__global__ void coset_ntt_butterfly_kernel(forge_span_u32_t data __attribute__((unused)), forge_span_u32_t twiddle __attribute__((unused)), uint64_t half_n __attribute__((unused)));
__global__ void coset_intt_postprocess_kernel(forge_span_u32_t data __attribute__((unused)), forge_span_u32_t inv_shift_powers __attribute__((unused)), uint64_t n __attribute__((unused)));
__global__ void coset_linepoly_eval_kernel(forge_span_u32_t out __attribute__((unused)), forge_span_u32_t coset_x __attribute__((unused)), uint32_t f0 __attribute__((unused)), uint32_t f1 __attribute__((unused)), uint64_t n __attribute__((unused)));
__global__ void coset_twiddle_adjust_kernel(forge_span_u32_t coset_twiddle __attribute__((unused)), forge_span_u32_t std_twiddle __attribute__((unused)), forge_span_u32_t shift_pow __attribute__((unused)), uint64_t n __attribute__((unused)));
int main();
...
__global__ void coset_ntt_preprocess_kernel(forge_span_u32_t data __attribute__((unused)), forge_span_u32_t shift_powers __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  if ((tid < n)) {
    ...
    uint32_t s __attribute__((unused)) = m31_get(shift_powers, tid);
...
__global__ void coset_ntt_butterfly_kernel(forge_span_u32_t data __attribute__((unused)), forge_span_u32_t twiddle __attribute__((unused)), uint64_t half_n __attribute__((unused))) {
  ...
  if ((tid < half_n)) {
    /* assert erased */;
    /* assert erased */;
    uint32_t a __attribute__((unused)) = m31_get(data, tid);
    uint32_t b __attribute__((unused)) = m31_get(data, (tid + half_n));
    uint32_t w __attribute__((unused)) = m31_get(twiddle, tid);
    uint32_t wb __attribute__((unused)) = m31_mul(w, b);
    uint32_t a2 __attribute__((unused)) = m31_add(a, wb);
    uint32_t b2 __attribute__((unused)) = m31_sub(a, wb);
    data.data[tid] = a2;
    data.data[(tid + half_n)] = b2;
...
__global__ void coset_intt_postprocess_kernel(forge_span_u32_t data __attribute__((unused)), forge_span_u32_t inv_shift_powers __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  if ((tid < n)) {
    ...
    /* assert erased */;
    uint32_t v __attribute__((unused)) = m31_get(data, tid);
    uint32_t s __attribute__((unused)) = m31_get(inv_shift_powers, tid);
    data.data[tid] = m31_mul(v, s);
...
__global__ void coset_linepoly_eval_kernel(forge_span_u32_t out __attribute__((unused)), forge_span_u32_t coset_x __attribute__((unused)), uint32_t f0 __attribute__((unused)), uint32_t f1 __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  if ((tid < n)) {
    /* assert erased */;
    /* assert erased */;
    uint32_t x __attribute__((unused)) = m31_get(coset_x, tid);
    uint32_t f1x __attribute__((unused)) = m31_mul(f1, x);
    out.data[tid] = m31_add(f0, f1x);
...
__global__ void coset_twiddle_adjust_kernel(forge_span_u32_t coset_twiddle __attribute__((unused)), forge_span_u32_t std_twiddle __attribute__((unused)), forge_span_u32_t shift_pow __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  if ((tid < n)) {
    ...
    /* assert erased */;
    /* assert erased */;
    uint32_t t __attribute__((unused)) = m31_get(std_twiddle, tid);
    uint32_t s __attribute__((unused)) = m31_get(shift_pow, tid);
    coset_twiddle.data[tid] = m31_mul(s, t);
