...
__global__ void oods_numerator_kernel(forge_span_u32_t numer __attribute__((unused)), forge_span_u32_t eval __attribute__((unused)), uint32_t p_at_z __attribute__((unused)), uint64_t n __attribute__((unused)));
__global__ void oods_combine_kernel(forge_span_u32_t combined __attribute__((unused)), forge_span_u32_t numer __attribute__((unused)), uint32_t beta_pow __attribute__((unused)), uint64_t n __attribute__((unused)));
__global__ void oods_quotient_fused_kernel(forge_span_u32_t quot __attribute__((unused)), forge_span_u32_t eval __attribute__((unused)), forge_span_u32_t inv_denom __attribute__((unused)), uint32_t p_at_z __attribute__((unused)), uint32_t beta_pow __attribute__((unused)), uint64_t n __attribute__((unused)));
__global__ void oods_exclude_last_row_kernel(forge_span_u32_t quot __attribute__((unused)), uint64_t excluded_pos __attribute__((unused)), uint64_t n __attribute__((unused)));
int main();
...
__global__ void oods_numerator_kernel(forge_span_u32_t numer __attribute__((unused)), forge_span_u32_t eval __attribute__((unused)), uint32_t p_at_z __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  if ((x < n)) {
    /* assert erased */;
    /* assert erased */;
    uint32_t v __attribute__((unused)) = m31_get(eval, x);
    numer.data[x] = m31_sub(v, p_at_z);
...
__global__ void oods_combine_kernel(forge_span_u32_t combined __attribute__((unused)), forge_span_u32_t numer __attribute__((unused)), uint32_t beta_pow __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  if ((x < n)) {
    /* assert erased */;
    /* assert erased */;
    uint32_t c __attribute__((unused)) = m31_get(combined, x);
    uint32_t v __attribute__((unused)) = m31_get(numer, x);
    uint32_t bv __attribute__((unused)) = m31_mul(beta_pow, v);
    combined.data[x] = m31_add(c, bv);
...
__global__ void oods_quotient_fused_kernel(forge_span_u32_t quot __attribute__((unused)), forge_span_u32_t eval __attribute__((unused)), forge_span_u32_t inv_denom __attribute__((unused)), uint32_t p_at_z __attribute__((unused)), uint32_t beta_pow __attribute__((unused)), uint64_t n __attribute__((unused))) {
  ...
  if ((x < n)) {
    ...
    /* assert erased */;
    uint32_t v __attribute__((unused)) = m31_get(eval, x);
    uint32_t d __attribute__((unused)) = m31_get(inv_denom, x);
    uint32_t q __attribute__((unused)) = m31_get(quot, x);
    uint32_t num __attribute__((unused)) = m31_sub(v, p_at_z);
    uint32_t t __attribute__((unused)) = m31_mul(num, d);
    uint32_t con __attribute__((unused)) = m31_mul(beta_pow, t);
    quot.data[x] = m31_add(q, con);
