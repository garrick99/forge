...
__global__ void masked_softmax(forge_span_f32_t scores __attribute__((unused)), forge_span_u32_t mask __attribute__((unused)), forge_span_f32_t out __attribute__((unused)), uint64_t n_cols __attribute__((unused)));
int main();
...
__global__ void masked_softmax(forge_span_f32_t scores __attribute__((unused)), forge_span_u32_t mask __attribute__((unused)), forge_span_f32_t out __attribute__((unused)), uint64_t n_cols __attribute__((unused))) {
  ...
  uint32_t m_keep __attribute__((unused)) = 0ULL;
  if ((lane < n_cols)) {
    /* assume erased */;
    m_keep = mask.data[(base + lane)];
    if ((m_keep != 0ULL)) {
      /* assume erased */;
