...
__global__ void vec_2d_add(uint32_t* __restrict__ a, uint64_t a_len, uint32_t* __restrict__ b, uint64_t b_len, uint32_t* __restrict__ out, uint64_t out_len, uint32_t n, uint32_t width) {
